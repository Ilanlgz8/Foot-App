...
export function MatchDuJourCard({ match, espnScore = null, onClick }) {
  ...
  // ⚠️ BUG CORRIGÉ (30/07, même fix que MatchPoster.jsx — voir son
  // commentaire détaillé) : formMap/compMatches sont indexés par ids FD.org,
  // match.homeTeam.id est un id ESPN pour les 6 grands championnats — sans
  // résolution, prono neutre identique pour tous les matchs sans cote de
  // marché ESPN disponible.
