  ...
  return (
    <div className="accueil__section">
      <div className="accueil__sectionHeader">
        ...
        {!loading && pages > 1 && (
          <div className="accueil__carouselDots">
            {Array.from({ length: pages }).map((_, i) => (
              <button
                key={i}
                className={`accueil__carouselDot${i === page ? ' accueil__carouselDot--active' : ''}`}
                onClick={() => setPage(i)}
                aria-label={`Page ${i + 1}`}
              />
            ))}
      ...
      {loading && (
        <div className="accueil__carouselWrap">
          <div className="accueil__grid accueil__grid--carousel">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="accueil__card" style={{ pointerEvents: 'none' }}>
      ...
      {!loading && !error && (
        <div className="accueil__carouselWrap">
          <button
            className="accueil__carouselArrow accueil__carouselArrow--left"
          ...
          <button
            className="accueil__carouselArrow accueil__carouselArrow--right"
