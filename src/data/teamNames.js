export const TEAM_NAMES_FR = {
  ...
  // shortName "Olympique Lyon" y était). clubNameMatch (espnSummaryParse.js)
  // s'appuie maintenant aussi sur cette table pour rapprocher "Lyon" (nom
  // ESPN) de la variante FD.org rencontrée, quelle qu'elle soit — ceinture et
  // bretelles avec le shortName déjà couvert.
