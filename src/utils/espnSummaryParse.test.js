...
describe('clubNameMatch', () => {
  ...
  // startsWith ci-dessus échouait pour cette paire précise (contrairement à
  // Marseille, dont le shortName FD.org est déjà "Marseille"). Repli sur
  // TEAM_NAMES_FR (table figée, sans risque de collision type Manchester).
