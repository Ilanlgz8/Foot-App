...
// fonctionner (noms/buts plausibles, vérifié en direct sur 5 compétitions) —
// mais un recoupement demandé par l'utilisateur contre les VRAIS totaux
// d'équipe des standings ESPN a montré des chiffres mathématiquement
// impossibles pour la saison en cours (ex. Portugal 1 but marqué au total
// cette saison vs João Félix seul affiché à 2 buts ; Norvège 3 buts au total
// vs Haaland 4 + Bobb 2 = 6). L'endpoint /statistics semble donc renvoyer un
// cumul historique/all-time de la compétition plutôt que la saison affichée,
// sans paramètre de filtrage trouvé pour le corriger — retirée plutôt que
// laissée à afficher une donnée fausse. Voir NO_SCORERS_COMPS
// (data/competitions.js) et useScorers.js pour le détail complet.
