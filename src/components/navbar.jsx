    ...
    <nav className="navbar">
      ...
      <div className="navbar__quickNav">
        {navigation.map(item => (
          ...
          >
            {item.name === 'Accueil' && (
              <svg className="navbar__qnIcon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M3 10.5L12 3l9 7.5V20a1 1 0 01-1 1H15v-6H9v6H4a1 1 0 01-1-1V10.5z"/>
              </svg>
            )}
            {item.name === 'Programme' && (
              <svg className="navbar__qnIcon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            {item.name === 'Résultats' && (
              <svg className="navbar__qnIcon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <path d="M12 9v4.5l2.8 2"/>
                <path d="M9.5 3.5h5"/>
                <path d="M12 3.5v1.5"/>
              </svg>
            )}
            {item.name === 'Classement' && (
              <svg className="navbar__qnIcon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2"  y="13" width="5"  height="8" rx="1"/>
                <rect x="9.5" y="8"  width="5"  height="13" rx="1"/>
                <rect x="17" y="3"  width="5"  height="18" rx="1"/>
                <path d="M5 11l3-3 3 3 4-6" strokeWidth="1.5"/>
