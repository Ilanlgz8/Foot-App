...
// ⚠️ PAS de minuteur "minuit" dédié ici (tenté puis retiré, 23/07, même
// jour) : ne sert QUE si la page reste ouverte en continu sans jamais se
// remonter — et un setTimeout ne tourne de toute façon que tant que l'app est
// ouverte, donc inutile dès qu'on ferme l'app (retour utilisateur). hasMatchToday
